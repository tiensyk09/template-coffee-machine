                          ...
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              ...
                              <div style={{ display: 'flex', gap: '6px', marginTop: '8px', flexWrap: 'wrap' }}>
                                <span style={{ fontSize: '10px', padding: '2px 8px', borderRadius: '999px', background: '#ecfdf5', color: '#6f4e37', fontWeight: '700', border: '1px solid #a7f3d0' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              ...
                              <div style={{ display: 'flex', gap: '6px', marginTop: '8px' }}>
                                <span style={{ fontSize: '10px', padding: '2px 8px', borderRadius: '999px', background: plugin.free ? '#f7f1e8' : '#fffbeb', color: plugin.free ? '#6f4e37' : '#d97706', fontWeight: '700', border: '1px solid ' + (plugin.free ? '#e3d5c0' : '#fde68a') }}>
                                  {plugin.free ? 'Miễn phí' : plugin.price || 'Có phí'}
                                </span>
                              </div>
                            </div>
