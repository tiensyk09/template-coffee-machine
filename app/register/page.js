      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }} autoComplete="off">
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                onFocus={e => e.target.style.borderColor = '#5a3d29'}
          ...
          <button
            ...
            style={{
              ...
              padding: '12px',
              marginTop: '8px',
              background: loading ? '#6b7280' : 'linear-gradient(135deg, #5a3d29 0%, #15803d 100%)',
              border: 'none',
              borderRadius: '12px',
              color: '#ffffff',
              fontWeight: 800,
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '24px' }} className="login-back">
          ...
          <Link 
            ...
            style={{ fontSize: '13px', color: '#5a3d29', fontWeight: 600, textDecoration: 'none' }}
          >
            Đã có tài khoản? →
          </Link>
        </div>
