    ...
    <div style={{ backgroundColor: '#f5faf6', minHeight: '100vh', padding: '40px 0' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 0', background: '#ffffff', borderRadius: '16px', border: '1px solid #e5e7eb' }}>
            ...
            <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#2b1d12', marginBottom: '8px' }}>Không tìm thấy bài viết nào</h3>
              ...
              >
                ...
                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                    <span style={{ fontSize: '11px', fontWeight: 700, color: '#5a3d29', background: '#f2e9dc', padding: '4px 10px', borderRadius: '999px', textTransform: 'uppercase' }}>
                      Cẩm nang
                    </span>
                  ...
                  {/* Title */}
                  <h3 style={{ fontSize: '18px', fontWeight: 700, lineHeight: 1.4, color: '#2b1d12', margin: '0 0 12px 0' }}>
      ...
      <style jsx global>{`
        ...
        .lc-spinner {
          width: 40px;
          height: 40px;
          border: 3.5px solid #f2e9dc;
          border-top-color: #5a3d29;
          border-radius: 50%;
