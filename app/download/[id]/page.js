...
export async function generateMetadata({ params }) {
  ...
  if (!decoded) return { title: 'Asset Not Found | Coffee Machine' };
  ...
  if (!file || file.is_public === 0) {
    return { title: 'Asset Restricted | Coffee Machine' };
  }

  return {
    title: `Download: ${file.name} | Coffee Machine`,
    description: file.description || `Download asset ${file.name} securely from Coffee Machine.`
  };
}
