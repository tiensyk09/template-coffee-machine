...
const IconBean = ({ size = 36 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
    <circle cx="24" cy="24" r="21" fill="#5a4232" />
    <path d="M24 8c-6 5-6 11 0 16s6 11 0 16" stroke={GOLD} strokeWidth="2.4" strokeLinecap="round" fill="none" />
  </svg>
);
...
export default function Footer() {
  ...
  const cats = [
    'Máy pha cà phê espresso', 'Máy xay cà phê', 'Máy pha cà phê chuyên nghiệp',
    'Máy pha cà phê nhỏ giọt', 'Phụ kiện pha chế', 'Vệ sinh & bảo dưỡng', 'Cốc & dụng cụ pha chế',
  ];
  const support = [
    'Chính sách bảo hành', 'Chính sách đổi trả', 'Hướng dẫn mua hàng',
  ...
  return (
    <footer style={{ backgroundColor: '#2b1d12', color: CREAM, fontFamily: 'Inter, sans-serif', paddingTop: 52, paddingBottom: 22 }}>
      <div className="container mx-auto px-4">
          ...
          <div>
            <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 11, textDecoration: 'none', marginBottom: 16 }}>
              ...
              <div style={{ lineHeight: 1 }}>
                <Editable k="brand_name1" def="COFFEE" as="div" style={{ fontSize: 18, fontWeight: 900, color: '#fff', letterSpacing: '0.02em' }} />
                <Editable k="brand_name2" def="MACHINE" as="div" style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.32em', color: GOLD, marginTop: 3 }} />
              </div>
            </Link>
            <p style={{ fontSize: 13, lineHeight: 1.8, color: MUTED, fontWeight: 500, marginBottom: 18, maxWidth: 280 }}>
              <Editable k="footer_about" def="Chuyên cung cấp thiết bị pha chế cà phê chính hãng, chất lượng cao cho mọi nhu cầu từ cá nhân đến doanh nghiệp." as="span" multiline />
            </p>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 13, fontSize: 13, fontWeight: 500, color: MUTED }}>
              ...
              <li style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                ...
                <Editable k="contact_phone" def="0945 123 456" as="span" style={{ color: '#fff', fontWeight: 800 }} />
              </li>
              <li style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                ...
                <Editable k="contact_email" def="info@coffeemachine.vn" as="span" />
              </li>
              <li style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                ...
                <Editable k="contact_hours" def="Thứ 2 - Chủ nhật: 8:00 - 20:00" as="span" />
              </li>
            </ul>
          </div>
        </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 18, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, fontSize: 12.5, color: MUTED, fontWeight: 500 }}>
          <Editable k="footer_copyright" def="© 2024 Coffee Machine. All rights reserved." as="div" style={{ color: CREAM }} />
          <div style={{ display: 'flex', gap: 8 }}>
            {['VISA', 'MasterCard', 'JCB', 'ZaloPay', 'PayPal'].map((p) => (
