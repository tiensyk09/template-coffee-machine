    ...
    <aside style={{ display: 'flex', flexDirection: 'column', gap: '24px', position: 'sticky', top: '130px', alignSelf: 'flex-start' }}>
      ...
      {suggestedProducts.length > 0 && (
        <div style={{
          ...
          <h3 style={{ fontSize: '15px', fontWeight: 800, color: '#2b1d12', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '2px solid #f0faf4', paddingBottom: '8px' }}>
                ...
                <div key={prod.id} style={{ display: 'flex', flexDirection: 'column', gap: '8px', paddingBottom: '12px', borderBottom: '1px solid #f3f4f6' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minWidth: 0 }}>
                      ...
                      <div>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', flexWrap: 'wrap' }}>
                          <span style={{ fontSize: '13.5px', fontWeight: 700, color: '#5a3d29' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: addingId === prod.id ? '#fff' : '#5a3d29',
                      fontWeight: 700,
                      fontSize: '11.5px',
                      cursor: 'pointer',
                      display: 'flex',
                    ...
                    onMouseEnter={(e) => {
                      if (addingId !== prod.id) {
                        e.currentTarget.style.background = '#5a3d29';
                        e.currentTarget.style.color = '#fff';
                      }
                    }}
                    onMouseLeave={(e) => {
                      if (addingId !== prod.id) {
                        e.currentTarget.style.background = '#f2e9dc';
                        e.currentTarget.style.color = '#5a3d29';
                      }
                    }}
                  >
